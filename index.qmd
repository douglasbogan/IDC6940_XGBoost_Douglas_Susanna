...
|               | Development) (20=1 story 1946-recent, 30=1 story 1945   |
| (stored as    | or older, 40=1 story w/finished attic, 45=1.5 story     |
| int64)        | unfinished, 50=1.5 story finished, 60=2 story           |
|               | 1946-recent, 70=2 story 1945 or older, 75=2.5 story,    |
|               | 80=Split/multi-level, 85=Split foyer, 90=Duplex, 120=1  |
|               | story PUD 1946-recent, 160=2 story PUD 1946-recent,     |
|               | 180=Multilevel PUD including split-level/foyer, 190=2   |
|               | family conversion)                                      |
+---------------+---------------------------------------------------------+
...
+---------------+---------------------------------------------------------+
| LotConfig     | Lot configuration (Inside, Corner, CulDSac=Cul-de-sac,  |
...
|               | MeadowV=Meadow Village, Mitchel=Mitchell, NAmes=North   |
|               | Ames, NoRidge=Northridge, NPkVill=Northpark Villa,      |
|               | NridgHt=Northridge Heights, NWAmes=Northwest Ames,      |
|               | OldTown=Old Town, SWISU=SW of Iowa State University,    |
|               | Sawyer, SawyerW=Sawyer West, Somerst=Somerset,          |
|               | StoneBr=Stone Brook, Timber=Timberland, Veenker)        |
+---------------+---------------------------------------------------------+
| Condition1    | Proximity to condition (RR: Railroad) (Artery=Adjacent  |
|               | to arterial street, Feedr=Adjacent to feeder street,    |
| Condition2    | Norm=Normal, RRNn= Within 200 feet of North-South RR,   |
| (if more than | RRAn=Adjacent to North-South RR, PosN=Near positive     |
| 1)            | off-site feature (park, greenbelt, etc.), PosA=Adjacent |
|               | to positive off-site feature, RRNe=Within 200 feet of   |
|               | East-West RR, RRAe=Adjacent to East-West RR)            |
+---------------+---------------------------------------------------------+
| BldgType      | Dwelling type (1Fam=1 family detached, 2FmCon=2 family  |
|               | conversion from 1 family, Duplx=Duplex,                 |
...
|               | unfinished, 2Story=2 story, 2.5Fin=2.5 story, 2nd level |
|               | finished, 2.5Unf=2.5 story, 2nd level unfinished,       |
|               | SFoyer=Split foyer, SLvl=Split level)                   |
+---------------+---------------------------------------------------------+
| RoofStyle     | Roof style (Flat, Gable, Gambrel=Gabriel (Barn), Hip,   |
|               | Mansard, Shed)                                          |
+---------------+---------------------------------------------------------+
| RoofMatl      | Roof material (ClyTile=Clay/Tile, CompShg=Standard      |
|               | (composite) shingle, Membran=Membrane, Metal, Roll,     |
|               | Tar&Grv=Gravel & tar, WdShake=Wood shakes, WdShngl=Wood |
|               | shingles)                                               |
+---------------+---------------------------------------------------------+
| Exterior1st   | Exterior material (AsbShng=Asbestos shingles,           |
|               | AsphShn=Asphalt shingles, BrkComm=Brick common,         |
| Exterior2nd   | BrkFace=Brick face, CBlock=Cinder block, CemntBd=Cement |
| (if more than | board, HdBoard=Hard board, ImStucc=Imitation stucco,    |
| 1)            | MetalSd=Metal siding, Other, Plywood, Stone, Stucco,    |
|               | VinylSd=Vinyl siding, Wd Sdng=Wood siding, WdShing=Wood |
|               | shingles)                                               |
+---------------+---------------------------------------------------------+
| MasVnrType    | Masonry veneer type (BrkCmn=Brick common, BrkFace=Brick |
|               | face, None, Stone)                                      |
+---------------+---------------------------------------------------------+
| ExterQual     | Exterior material quality (Ex=Excellent, Gd=Good,       |
|               | TA=Average/Typical, Fa=Fair)                            |
+---------------+---------------------------------------------------------+
| ExterCond     | Present condition of exterior material (Ex=Excellent,   |
|               | Gd=Good, TA=Average/Typical, Fa=Fair, Po=Poor)          |
+---------------+---------------------------------------------------------+
| Foundation    | Type of foundation (BrkTil=Brick & tile, CBlock=Cinder  |
|               | block, PConc=Poured concrete, Slab, Stone, Wood)        |
+---------------+---------------------------------------------------------+
...
|               | TA=Typical - slight dampness allowed, Fa=Fair - dampnes |
|               | s/cracking/settling, Po=Poor - severe cracki            |
|               | ng/settling/wetness, NA=No basement)                    |
+---------------+---------------------------------------------------------+
| BsmtExposure  | Exposure of walkout/garden level basement walls (split  |
|               | levels/foyers typically score average or above)         |
|               | (Gd=Good, Av=Average, Mn=Minimum, No=None, NA=No        |
|               | basement)                                               |
+---------------+---------------------------------------------------------+
| BsmtFinType1  | Quality of basement finished area (GLQ=Good living      |
|               | quarters, ALQ=Average living quarters, BLQ=Below        |
| BsmtFinType2  | average living quarters, Rec=Average rec room, LwQ=Low  |
| (if more than | quality, Unf=Unfinshed, NA=No basement)                 |
| 1 type)       |                                                         |
+---------------+---------------------------------------------------------+
| Heating       | Type of heating (Floor=Floor furnace, GasA=Gas forced   |
|               | warm air furnace, GasW=Gas hot water or steam heat,     |
|               | Grav=Gravity furnace, OthW=Hot water/steam heat other   |
|               | than gas, Wall=Wall furnace)                            |
+---------------+---------------------------------------------------------+
...
|               | fireplace, Gd=Good - Masonry fireplace in main level,   |
|               | TA=Average - Prefabricated fireplace in main living     |
|               | area/Masonry fireplace in basement, Fa=Fair -           |
|               | Prefabricated fireplace in basement, Po=Poor - Ben      |
|               | Franklin stove, NA=No fireplace)                        |
+---------------+---------------------------------------------------------+
| GarageType    | Garage type (2Types=More than 1 type, Attchd=Attached   |
|               | to home, Basment=Basement, BuiltIn=Built-In (part of    |
|               | house - typically has room above garage), CarPort=Car   |
|               | Port, Detchd=Detached from home, NA=No garage)          |
+---------------+---------------------------------------------------------+
...
|               | privacy, GdWo=Good wood, MnWw=Minimum wood/wire, NA=No  |
|               | fence)                                                  |
+---------------+---------------------------------------------------------+
| MiscFeature   | Miscellaneous feature not covered in other categories   |
|               | (Gar2=2nd Garage not described in garage section,       |
|               | Othr=Other, Shed=Shed more than 100 square feet,        |
...
|               | COD=Court Officer Deed/Estate, Con=Contract 15% down,   |
|               | regular terms, ConLw=Contract low down payment & low    |
|               | interest, ConLI=Contract low interest, ConLD=Contract   |
|               | low down, Oth=Other)                                    |
+---------------+---------------------------------------------------------+
...
|               | w/separate deeds, typically condo & garage, Family=Sale |
|               | between family members, Partial=Home not yet completed  |
|               | at last assessment, associated w/new homes)             |
+---------------+---------------------------------------------------------+
...
+---------------+---------------------------------------------------------+
| YearRemodAdd  | Remodel year (same as construction date if none) (YYYY) |
+---------------+---------------------------------------------------------+
...
+---------------+---------------------------------------------------------+
| TotRmsAbvGrd  | Number of rooms above ground (not including bathrooms)  |
+---------------+---------------------------------------------------------+
